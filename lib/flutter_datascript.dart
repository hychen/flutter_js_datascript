...
/// This class implements Datascript Public Javascript APIs.
class FlutterDatascript {
  final jsEngine = getJavascriptRuntime(xhr: false);
  ...
  Future<DB> emptyDb({Schema? shcema}) {
  ...
  /// database.
  Future createConn({Schema? schema}) {
    throw UnimplementedError();
  }
  ...
  ///
  /// Returns [TxReport].
  Future<TxReport> transact(conn, List txDeta, {txMeta}) {
    throw UnimplementedError();
  }
  ...
  String listen(conn, Function callback, {String? key}) {
    throw UnimplementedError();
  }

  /// Removes registered listener from connection. See also [[listen!]].
  unListen(conn, String key) {
    throw UnimplementedError();
  }
